    ...
    <footer className="bg-white border-t border-border-default/40">
      <div className="max-w-[1440px] mx-auto page-x py-14">
        <div className="flex flex-col md:flex-row md:justify-between gap-12">
              ...
              <div className="flex items-center gap-2">
                {socialLinks.map((s) => (
                  <a
                    ...
                    href={s.href}
                    aria-label={s.label}
                    className="w-9 h-9 rounded-full border shadow-lg border-border-default/50 flex items-center justify-center text-text-secondary hover:border-brand-primary hover:text-brand-primary transition-colors duration-200"
                  >
                    {s.icon}
                  </a>
                ))}
          ...
          {/* Right columns — Company + Contact */}
          <div className="flex flex-col sm:flex-row gap-12 sm:gap-16 lg:gap-24">

            {/* Company */}
            <div className="flex flex-col gap-4">
              <h4
                className="text-text-primary font-semibold text-[24px]"
